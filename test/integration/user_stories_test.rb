...
class UserStoriesTest < ActionDispatch::IntegrationTest
  ...
  test "buying a product" do
    ...
    perform_enqueued_jobs do
    	...
    	assert_equal "Duke Lebowski",    order.name
    	assert_equal "Compton st",       order.address
    	assert_equal "duke@example.com", order.email
    	...
    	assert_equal ["duke@example.com"], mail.to
